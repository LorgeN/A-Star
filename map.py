...
class CourseMap:
    ...
    # EDITED: Added function to get width and height of map to develop custom
    # hash function (1 index per slot in map)

    def get_width(self):
        return self.int_map.shape[1]

    def get_height(self):
        return self.int_map.shape[0]
